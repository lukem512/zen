...
function drawCountsGraph (selector, sort, trim, width, height) {
  width = width || 960;
  height = height || 500;
  ...
  d3.csv("/admin/analysis/data/counts", function(error, data) {
    if (error) throw error;

    data.forEach(function(d) {
      d.Count = +d.Count; // Format as number
    });
